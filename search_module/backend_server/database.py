...
res = es.index(index='streams1',doc_type='video',body=e4)
res = es.index(index='streams1',doc_type='video',body=e5)
res = es.index(index='streams1',doc_type='video',body=e6)
res = es.index(index='streams1',doc_type='video',body=e7)
res = es.index(index='streams1',doc_type='video',body=e8)
res = es.index(index='streams1',doc_type='video',body=e9)
res = es.index(index='streams1',doc_type='video',body=e10)
res = es.index(index='streams1',doc_type='video',body=e11)
res = es.index(index='streams1',doc_type='video',body=e12)
